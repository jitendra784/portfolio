        ...
        <ul>
          <li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className='h-4 w-4 mr-2 mt-1.5 text-[#3A86FF]' fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  </svg><Link to="/home" className="text-slate-300 hover:text-white">Home</Link></div></li>
          <li>
            <div className='flex pb-1'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 mt-1.5 text-[#3A86FF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                  </svg>
                 <Link to="/about" className="text-slate-300 hover:text-white">About Me</Link>
                  </div> </li>
          <li>
            <div className='flex pb-1'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 mt-1.5 text-[#3A86FF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
         ...
         <li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 mt-1.5 text-[#3A86FF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <Link to="/team" className="text-slate-300 hover:text-white">Team</Link>
                  </div> </li>
                  <li>
            <div className='flex pb-1'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 mt-1.5 text-[#3A86FF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 ...
                 <Link to="/testimonials" className="text-slate-300 hover:text-white">Testimonials</Link>
                  </div> </li>
        ...
        <ul>
          <li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className='h-4 w-4 mr-2 mt-1.5 text-red-700' fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                  </svg><a href='#service' className='text-slate-300 hover:text-white'>Mobile App Development</a></div></li>
          <li>
            <div className='flex pb-1'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 mt-1.5 text-red-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 ...
                 <a href='#service' className='text-slate-300 hover:text-white'>Web Development</a>
                  </div> </li>
          <li>
            <div className='flex pb-1'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 mt-1.5 text-red-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 ...
                 <a href='#service' className='text-slate-300 hover:text-white'>Custom Software Solutions</a>
                  </div> </li>
         <li>
            <div className='flex pb-1'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 mt-1.5 text-red-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 ...
                 <a href='#service' className='text-slate-300 hover:text-white'>UI/UX Optimization</a>
                  </div> </li>
         <li>
            <div className='flex pb-1'>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 mt-1.5 text-red-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 ...
                 <a href='#service' className='text-slate-300 hover:text-white'>Maintenance & Support</a>
                  </div> </li>
